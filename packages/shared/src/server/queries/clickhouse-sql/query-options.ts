 ...
 *
 * Logic flow:
 * 1. Check ELASTICDASH_API_CLICKHOUSE_DISABLE_OBSERVATIONS_FINAL (takes precedence)
 * 2. If ELASTICDASH_SKIP_FINAL_FOR_OTEL_PROJECTS is enabled, check Redis for project OTEL usage
 * 3. Returns boolean
 */
export async function shouldSkipObservationsFinal(
  ...
  if (env.ELASTICDASH_API_CLICKHOUSE_DISABLE_OBSERVATIONS_FINAL === "true") {
