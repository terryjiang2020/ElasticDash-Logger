...
const CUSTOM_EMAIL_CLAIM = env.ELASTICDASH_CUSTOM_SSO_EMAIL_CLAIM;
const CUSTOM_NAME_CLAIM = env.ELASTICDASH_CUSTOM_SSO_NAME_CLAIM;
const CUSTOM_SUB_CLAIM = env.ELASTICDASH_CUSTOM_SSO_SUB_CLAIM;
